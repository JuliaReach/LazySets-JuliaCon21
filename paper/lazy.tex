...
In the first benchmark we evaluate the support function for the lazy set.
In the second benchmark we evaluate the support function including the conversion to a concrete set representation (in this case a polygon in vertex representation).
